...
import { ActionModal, GenericTable, GenericTableProps } from '@base-frontend';
import {
  BookingRequestForm,
  ListingsContext,
  PrimaryText,
} from '@offisito-frontend';
import { ChatBubble, Delete, Edit, OpenInFull } from '@mui/icons-material';
import ProfileForm from '../../forms/ProfileForm';
import { Booking, UserType } from '@offisito-shared';
    ...
    },
    {
      ...
      actions: [
        ...
        },
        {
          name: 'Review',
          icon: <OpenInFull />,
          modal: (closeModal: TODO, _: string, theItem: Booking) => (
            <BookingRequestForm
              close={closeModal}
              previousBookingDetails={theItem}
              readOnly
            />
          ),
        },
