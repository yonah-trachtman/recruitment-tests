      ...
      >
        ...
        <Grid paddingTop="8px" paddingLeft="16px" paddingRight="16px">
          ...
          {space.assetAmenities && (
            <AllOfficeAmenities accessedAmenities={space.assetAmenities} />
          )}
        </Grid>

        <Grid paddingTop="8px" paddingLeft="16px" paddingRight="16px">
          <PrimaryText color="text.secondary">
            {space.assetDescription}
          </PrimaryText>
        </Grid>
        ...
        <Grid paddingTop="8px" paddingLeft="16px" paddingRight="16px">
          <PrimaryText variant="h5">
            ...
            {space.floorNumber ? `F(${space.floorNumber})` : ''}
          </PrimaryText>
        </Grid>
