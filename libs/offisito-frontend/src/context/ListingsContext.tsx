...
import { Amenity, Asset, Building, Company, UserType } from '@offisito-shared';
import { axiosErrorToaster, ServerContext, useSubscribe } from '@base-frontend';
...
export const ListingsContextProvider = ({
  ...
  const { res } = useSubscribe(domain, 'api/host/subscribe');
